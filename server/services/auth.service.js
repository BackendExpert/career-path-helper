...
class AuthService {
    static async registation(username, email, password, req) {
        ...
        await sendEmail({
            to: email,
            subject: "Welcome to BlackAlphaLabs Employee Management System",
            html: `
        <div style="font-family: 'Segoe UI', Arial, sans-serif; background-color: #f7f7f7; padding: 40px 0;">
            <div style="max-width: 600px; margin: auto; background: #ffffff; border-radius: 14px; overflow: hidden; box-shadow: 0 10px 35px rgba(0,0,0,0.08);">
                ...
                <div style="padding: 35px; color: #333;">
                    <h2 style="font-size: 22px; margin-bottom: 12px; color: #301934;">Hello ${username},</h2>

                    <p style="font-size: 16px; line-height: 1.6; margin-bottom: 20px; color: #4b5563;">
                        You’ve successfully registered to the <strong>BlackAlphaLabs Employee Management System</strong>. 
                        Please verify your email using the OTP below:
                    </p>

                    <div style="font-size: 32px; font-weight: 800; letter-spacing: 6px; color: #ffffff; background: #301934; padding: 18px; text-align: center; border-radius: 12px; margin: 35px 0;">
                        ${otp}
                    </div>
                    ...
                    <p style="font-size: 15px; color: #475569;">
                        💼 Once verified, you can log in to manage your employee profile and access system features.
                    </p>
                </div>

                <!-- Footer -->
                <div style="background-color: #f9fafb; padding: 20px; text-align: center; font-size: 13px; color: #9ca3af;">
                    <p style="margin: 5px 0;">© ${new Date().getFullYear()} BlackAlphaLabs Employee Management System</p>
    ...
    static async login(email, password, req) {
        ...
        if (req) {
            ...
            await sendEmail({
                to: email,
                subject: "Login Successful | BlackAlphaLabs Employee Management System",
                html: `
        <div style="font-family: 'Segoe UI', Arial, sans-serif; background-color: #f7f7f7; padding: 40px 0;">
            <div style="max-width: 600px; margin: auto; background: #ffffff; border-radius: 14px; overflow: hidden; box-shadow: 0 10px 35px rgba(0,0,0,0.08);">
                ...
                <div style="background: #301934; padding: 25px; text-align: center;">
                    ...
                    <p style="color: #d1c4e9; margin: 6px 0 0; font-size: 15px;">
                        BlackAlphaLabs Employee Management System
                    </p>
                </div>
                ...
                <div style="padding: 35px; color: #333;">
                    ...
                    <p style="font-size: 16px; line-height: 1.6; margin-bottom: 20px; color: #4b5563;">
                        👋 You’ve successfully logged into the <strong>BlackAlphaLabs Employee Management System</strong>. 
                        If this was you, everything is fine. Otherwise, please review your account security immediately.
                    </p>

                    <div style="background: #301934; color: #ffffff; border-radius: 12px; padding: 18px 22px; margin: 25px 0;">
    ...
    static async ForgetPassword(email, req) {
        ...
        await sendEmail({
            to: email,
            subject: "Password Reset Request | BlackAlphaLabs Employee Management System",
            html: `
        <div style="font-family: 'Segoe UI', Arial, sans-serif; background-color: #f7f7f7; padding: 40px 0;">
            <div style="max-width: 600px; margin: auto; background: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 10px 40px rgba(0,0,0,0.08);">
                ...
                <div style="padding: 35px; color: #333;">
                    ...
                    <p style="font-size: 16px; line-height: 1.7; margin-bottom: 20px; color: #4b5563;">
                        We received a request to reset your password for the <strong>BlackAlphaLabs Employee Management System</strong>. 
                        Please use the OTP below to securely continue:
                    </p>

                    <div style="font-size: 32px; font-weight: 800; letter-spacing: 6px; color: #fff; background: #301934; padding: 20px; text-align: center; border-radius: 12px; margin: 35px 0;">
                        ${otp}
                    </div>
                    ...
                    <p style="font-size: 15px; color: #475569;">
                        💼 Once verified, you can securely set a new password and regain access to your BlackAlphaLabs EMS account.
                    </p>
                </div>
    ...
    static async UpdatePassword(token, newpassword, req) {
        ...
        if (updatedUser) {
            if (req) {
                ...
                await sendEmail({
                    to: user.email,
                    subject: "✅ Password Updated Successfully | BlackAlphaLabs Employee Management System",
                    html: `
        <div style="font-family: 'Segoe UI', Arial, sans-serif; background-color: #f7f7f7; padding: 40px 0;">
            <div style="max-width: 600px; margin: auto; background: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 10px 40px rgba(0,0,0,0.08);">
                ...
                <div style="padding: 35px; color: #333; text-align: center;">
                    ...
                    <p style="font-size: 16px; line-height: 1.7; margin-bottom: 25px; color: #4b5563;">
                        ...
                        Your password for your <strong>BlackAlphaLabs Employee Management System</strong> account has been updated successfully.  
                        You can now log in using your new password.
                    </p>

                    <a href='${FRONTEND_URL}/login' 
                        style="display: inline-block; padding: 14px 26px; background: #301934;
                        color: #fff; font-size: 15px; font-weight: 600; text-decoration: none; border-radius: 10px;
                        box-shadow: 0 4px 10px rgba(48,25,52,0.3); transition: background 0.3s;">
                        🔑 Go to Login
                    </a>
                    ...
                    <p style="font-size: 15px; color: #475569;">
                        💼 Access your BlackAlphaLabs EMS account securely anytime.
                    </p>
                </div>
